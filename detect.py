...
# IP Camera URLs
URL_1 = "http://192.168.0.156:8084/video"
URL_2 = "http://192.168.0.196:8081/video"
...
KNOWN_DISTANCE_BETWEEN_CAMERAS = 78 # cm
FOCAL_LENGTH = 505 # Pixels
...
while True:
    ...
    camera_distance_above_ground=82.5
    # Process detections
    x1, y1, x2, y2 = -1, -1, -1, -1
